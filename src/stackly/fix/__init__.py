"""Stackly fix-loop subpackage — the autonomous / interactive crash-repair agent.
...
``stackly`` CLI loads on machines without Windows Debugging Tools installed.

Public surface is exposed through :mod:`stackly.fix.dispatcher` (lands in
